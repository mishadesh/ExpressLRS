...
const fhss_config_t domains[] = {
    ...
    {"UA600",  FREQ_HZ_TO_REG_VAL(550000000), FREQ_HZ_TO_REG_VAL(650000000), 100, 600000000},
    {"UA410",  FREQ_HZ_TO_REG_VAL(380000000), FREQ_HZ_TO_REG_VAL(440000000), 60, 410000000},
    {"UA205",  FREQ_HZ_TO_REG_VAL(200000000), FREQ_HZ_TO_REG_VAL(210000000), 10, 205000000},
    {"C170W23",  FREQ_HZ_TO_REG_VAL(158300000), FREQ_HZ_TO_REG_VAL(181700000), 40, 170000000}, // #11, 170/23.4 central/fhss
    {"C190W23",  FREQ_HZ_TO_REG_VAL(178300000), FREQ_HZ_TO_REG_VAL(201700000), 40, 190000000}, // #12, 190/23.4 central/fhss
    {"UA500",  FREQ_HZ_TO_REG_VAL(470000000), FREQ_HZ_TO_REG_VAL(520000000), 50, 500000000},
    {"UA500_2",  FREQ_HZ_TO_REG_VAL(450000000), FREQ_HZ_TO_REG_VAL(550000000), 100, 500000000},
    {"UA490",  FREQ_HZ_TO_REG_VAL(490000000), FREQ_HZ_TO_REG_VAL(560000000), 70, 525000000},
    {"UA630",  FREQ_HZ_TO_REG_VAL(610000000), FREQ_HZ_TO_REG_VAL(650000000), 40, 630000000},
};
