...
__attribute__ ((used)) static firmware_options_t flashedOptions = {
    ...
    .domain = 7,
    #elif defined(Regulatory_Domain_UA_550_650_100)
    .domain = 8,
    #elif defined(Regulatory_Domain_UA_380_440_60)
    .domain = 9,
    #elif defined(Regulatory_Domain_UA_200_210_10)
    .domain = 10,
    #elif defined(Regulatory_Domain_C170W23)
    .domain = 11,
    #elif defined(Regulatory_Domain_C190W23)
    .domain = 12,
    #elif defined(Regulatory_Domain_UA_470_520_50)
    .domain = 13,
    #elif defined(Regulatory_Domain_UA_450_550_100)
    .domain = 14,
    #elif defined(Regulatory_Domain_UA_490_560_70)
    .domain = 15,
    #elif defined(Regulatory_Domain_UA_610_650_40)
    .domain = 16,
    #else
